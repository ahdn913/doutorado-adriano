// COMPILAÇÃO: gcc sir_vd_rk4.c -Wall -lm -o sir_vd_rk4
// EXECUÇÃO: ./sir_vd_rk4 s0 i0 r0 dt tf np (suscetíveis, infectados e vacinados iniciais, intervalo de tempo, tempo total e número de pontos)
...
double h(double I, double R){ // terceira eq dif R
	double gamma= 0.15;
	double B= 0.01;
	double mu= 0.01;
	return (gamma*I - mu*R);
