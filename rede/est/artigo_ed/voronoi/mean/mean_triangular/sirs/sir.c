...
// 1 = Suscetível, 2 = Infectado, 3 = Recuperado, 4 = Exposto
...
int main(int argc, char **argv){
	int i, j, x; 
	int ativo, passivo, vizinho, cont_inf, cont_sus, cont_s, cont_i, cont_r, cont_v, cont_e, trigger= 0;
	int max, t=0;
