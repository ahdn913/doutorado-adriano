// gcc sir_vax_snap12.c -O3 -Wall -lgsl -lgslcblas -lm -o sir_vax_snap12
// ./sir_vax_snap12
// for I in $(seq 1 100); do echo $I; ./sir_vax_snap12 $I ;done
		...
		while(cont_sus > 0){
			while(cont_inf > 0){
				while(t < 500){
					...
					sprintf(name, "plot_curve/data-%ld.dat", gsl_rng_default_seed); // Retorna uma string de acordo com a string de formatação Format
