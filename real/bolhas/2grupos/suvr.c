...
int main(int argc, char **argv){
	int i, j, n, o, t, k, O, K, inf, i0, vio, i2, cont_s, cont_i1, cont_i2, cont_v1, cont_v2, cont_r; // k é o contador de indivíduos 
	...
	arq= fopen(clus, "w"); // Abre o arquivo contido no primeiro parâmetro, usando o modo dado no segundo parâmetro. com o "w", o arquivo é criado se não existir.	
	fprintf(arq, "0 %d %d %d %d %d\n", cont_s, cont_i1, cont_v1, cont_i2, cont_v2);
	fclose(arq);
...
// morte - fim
		...
		fprintf(arq, "%d %d %d %d %d %d\n", t, cont_s, cont_i1, cont_v1, cont_i2, cont_v2);
		fclose(arq);
	}
	gsl_rng_free(w);
	free(p);
