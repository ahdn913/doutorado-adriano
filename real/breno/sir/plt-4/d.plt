...
plot \
sprintf("../dat-4/d-%d.dat", @ARG1) u ($0+1000):($1) w l lw 1.5 lc rgb "#ff0000" t"$\\rho_1$",\
sprintf("../dat-4/d-%d.dat", @ARG1) u ($0+1000):($3) w l lw 1.5 lc rgb "#0000ff" t"$\\rho_2$",\
sprintf("../dat-4/d-%d.dat", @ARG1) u ($0+1000):($2) w l lw 1.5 lc rgb "#ffff00" t"$\\rho_3$"
